...
\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{../bilder/HimmelblauRandom/himmelblauoverview.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{../bilder/HimmelblauRandom/himmelblauall.png}
