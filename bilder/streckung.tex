...
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.1] (5.74,2.92) -- (6.38,0.7) -- (11,1.52) -- cycle;
\draw [color=zzttqq] (5.74,2.92)-- (10.36,3.74);
\draw [color=zzttqq] (10.36,3.74)-- (11,1.52);
\draw [color=zzttqq] (11,1.52)-- (5.74,2.92);
\draw (9.03,2.73)-- (6.38,0.7);
\draw [color=zzttqq] (5.74,2.92)-- (6.38,0.7);
\draw [color=zzttqq] (6.38,0.7)-- (11,1.52);
\draw [color=zzttqq] (11,1.52)-- (5.74,2.92);
\begin{scriptsize}
...
\fill [color=uuuuuu] (6.38,0.7) circle (1.5pt);
\draw[color=uuuuuu] (6.57,0.65) node {$x_{streck}$};
\end{scriptsize}
\end{tikzpicture}
