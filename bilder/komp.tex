...
\fill[color=zzttqq,fill=zzttqq,fill opacity=0.1] (5.74,2.92) -- (8.05,3.33) -- (8.37,2.22) -- cycle;
\draw [color=zzttqq] (5.74,2.92)-- (10.36,3.74);
\draw [color=zzttqq] (10.36,3.74)-- (11,1.52);
\draw [color=zzttqq] (11,1.52)-- (5.74,2.92);
\draw [color=zzttqq] (11,1.52)-- (5.74,2.92);
\draw [color=zzttqq] (5.74,2.92)-- (8.05,3.33);
\draw [color=zzttqq] (8.05,3.33)-- (8.37,2.22);
\draw [color=zzttqq] (8.37,2.22)-- (5.74,2.92);
\begin{scriptsize}
...
\draw[color=uuuuuu] (8.54,2.29) node {$x_{3neu}$};
\fill [color=uuuuuu] (8.05,3.33) circle (1.5pt);
\draw[color=uuuuuu] (8.22,3.42) node {$x_{1neu}$};
